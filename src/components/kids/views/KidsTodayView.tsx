            ...
            <div className="z-20 transform transition-transform hover:scale-105 duration-300 relative mt-24 cursor-pointer" onClick={() => setShowBubble(!showBubble)}>
                ...
                {isMili ? (
                    <img
                        ...
                        alt="Mili"
                        className="w-64 h-auto object-contain saturate-110 filter drop-shadow-[0_15px_15px_rgba(0,0,0,0.4)] transition-transform hover:scale-105 duration-300 relative z-20"
                    />
                ) : (
                    <img
